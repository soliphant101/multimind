...
with col1:
    st.markdown('<h4 class="title-font">DeepSeek R1</h4>', unsafe_allow_html=True)
...
with col2:
    st.markdown('<h4 class="title-font">LLaMA 3</h4>', unsafe_allow_html=True)
...
with col3:
    st.markdown('<h4 class="title-font">Gemini 2.0</h4>', unsafe_allow_html=True)
    conversation = ""
    for sender, message in st.session_state.chat_history_3:
        safe_message = html.escape(message)
        conversation += f"\n**{sender}:**\n{safe_message}\n\n"
